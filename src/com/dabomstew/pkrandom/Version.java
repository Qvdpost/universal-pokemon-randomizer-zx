...
public class Version {
    public static final int VERSION = 329; // Increment by 1 for new version. Updated for 4.6.2-dev.
    public static final String VERSION_STRING = "4.6.8";
    ...
    private static Map<Integer,String> setupVersionsMap() {
        ...
        map.put(320, "4.5.1");
        map.put(321, "4.6.0");
        map.put(322, "4.6.1-dev");
        map.put(323, "4.6.2-dev");
        map.put(324, "4.6.3-dev");
        map.put(325, "4.6.4");
        map.put(326, "4.6.5");
        map.put(327, "4.6.6");
        map.put(328, "4.6.7");
